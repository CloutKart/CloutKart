      ...
      <div className="w-full max-w-md">
        <div className="glass-card rounded-3xl p-8 sm:p-10" style={{ background: 'rgba(12,12,12,0.97)' }}>
          <div className="mb-8">
            ...
            <p className="text-[#9CA3AF] text-sm">Enter your email to receive a reset link.</p>
          </div>

          {sent ? (
            <div className="glass-card rounded-2xl p-6 text-center">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: 'rgba(6,182,212,0.1)', border: '1px solid rgba(6,182,212,0.2)' }}>
              ...
              <p className="text-[#9CA3AF] text-sm">We sent a password reset link to <span className="text-white">{email}</span>.</p>
            </div>
          ) : (
